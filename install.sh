...
mkdir -p /var/lib/video_looper /var/lib/video_looper/savestates
...
echo ""
echo "Web UI: http://<pi-ip>/  (LAN-only, no auth)"
echo "Note: existing USB drives mounted before this install"
echo "      stay read-only until replug or remount,rw."
echo "      Disable the web UI with [web] enabled = false"
echo "      in /boot/video_looper.ini if needed."
echo "=========================================="
